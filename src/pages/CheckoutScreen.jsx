...
class CheckoutScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = { stageCompleteStatus: "#eeeeee" };
  }

  componentDidMount() {
    if (this.props.role === "customer") {
      this.setState({ stageCompleteStatus: "#228b22" });
    }
  }
            ...
            <div className="container addressDetailContainer">
              <div className="row addressDetailsHeader">
                <div className="col-lg-6">
                  <FaCheckCircle color={this.state.stageCompleteStatus} /> 1.
                  ADDRESS DETAILS
                </div>
              ...
              <div className="row theAddressDetailsContainer">
                ...
                <div>
                  Blue top estate, House Number HE 44/4, blue top, next to
